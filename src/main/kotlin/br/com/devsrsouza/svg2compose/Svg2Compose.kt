...
object Svg2Compose {
    ...
    fun parse(
        ...
        vectorsDirectory.walkTopDown()
            ...
            .onEnter { file ->
                ...
                val groupPackage = previousGroup
                    ?.let { group -> "${group.groupPackage}.${group.groupName.second.lowercase()}" }
    ...
    private fun drawableTempDirectory(): File = createTempDirectory().toFile()
